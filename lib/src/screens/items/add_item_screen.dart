...
class _AddItemScreenState extends ConsumerState<AddItemScreen> {
  ...
  // Controller for barcode (uncommented)
  ...
  void dispose() {
    ...
    _barcodeController.dispose(); // Dispose barcode controller too (uncommented)
    super.dispose();
  }
  ...
  Future<void> _saveItem() async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final newItemData = {
        ...
        'barcode': _barcodeController.text.trim(), // Include barcode (uncommented)
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Location (e.g., A1-S2-B3)'),
                 textInputAction: TextInputAction.done, // Show 'done' action button on keyboard
                 // Optionally save when 'done' is pressed on keyboard
                 onFieldSubmitted: (_) => _isLoading ? null : _saveItem(),
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
